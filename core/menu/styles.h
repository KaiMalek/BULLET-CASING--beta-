...
void SetupStyles()
{
	...
	colors[ImGuiCol_Separator] = ImVec4(0.f, 0.f, 0.f, 1.00f);
	colors[ImGuiCol_SeparatorHovered] = ImVec4(0.1f, 0.f, 0.f, 1.00f);
	colors[ImGuiCol_SeparatorActive] = ImVec4(0.f, 0.f, 0.f, 1.00f);
