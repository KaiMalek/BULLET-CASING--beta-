...
#include "../../core/menu/variables.h"

bool ImGui::Checkbox(const char* label, bool* v, bool safe)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    if (*v)
        window->DrawList->AddRectFilledMultiColor(pos + ImVec2(2, 2), pos + ImVec2(10, 10), ImColor(variables::menu_color[0], variables::menu_color[1], variables::menu_color[2], g.Style.Alpha), ImColor(variables::menu_color[0], variables::menu_color[1], variables::menu_color[2], g.Style.Alpha), ImColor(30 / 255.f, 30 / 255.f, 30 / 255.f, g.Style.Alpha), ImColor(30 / 255.f, 30 / 255.f, 30 / 255.f, g.Style.Alpha));
